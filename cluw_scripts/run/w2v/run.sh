...
embedding_path="/home/antonio/lattes/2.0/w2v/embeddings/"
embedding="embeddings/"
#embeddings=("titles" "titles_sw" "titles_lem" "all_titles" "all_titles_lem" "google")
embeddings=("titles_lem" "all_titles_lem")
...
base=("titles_lem" "all_titles_lem")
...
do
    ...
    script -c "python3 embeddings.py $base_path$i'.txt' $embedding_path$i/'embedding' $embedding_path$i'/accuracy.csv'" 'logs/'$i'_embedding_log.txt'
done
